...
👋 Hi! I’m Siva Sankar, a B.Tech CSE (AI & ML) student and freelance video editor exploring how AI, automation, and creativity can come together to solve real problems.

🎬 I work as a self-employed video editor, creating wedding videos, reels, promotional content, and thumbnails for diverse clients. Alongside freelancing, I actively explore AI tools and machine learning concepts to understand how intelligent systems work in practice.

🤖 I’m currently focused on learning AI & ML from the ground up building small but meaningful projects like facial expression detection and script emotion prediction using Python, OpenCV, and basic NLP techniques.

✍️ I also enjoy writing and sharing what I learn on Medium, especially around beginner-friendly tech concepts, learning journeys, and practical insights from projects.

💬 You can talk to me about AI basics, ML learning paths, automation with tools like n8n, freelancing as a beginner, or creative video editing workflows.
...
<details>
  ...
  - Actively exploring AI, ML, and automation
  - Freelancing as a video editor while studying
...
<details>
  ...
  - Built beginner-to-intermediate AI & ML projects
  - Hands-on experience with Python, OpenCV, NLP basics
  - Experience working with real clients as a freelancer
  - Regular learner and contributor in tech communities
  - Writing technical and learning content on Medium

  💜 GitHub Zone
  - AI & ML beginner projects (Facial Expression Detection, Script Emotion Prediction)
...
> Find all of my projects at [github_RACHAMADUGUSIVASANKAR](https://github.com/RACHAMADUGUSIVASANKAR) with timeline, tech stack and necessary links.&nbsp;

| Projects | Deployed Link | Repository | Tech Stack & Tools |
|:---------|:-------------:|:----------:|:-------------------|
| Portfolio | [View](https://rachamadugusivasankar.github.io/Book-portfolio/) | [view](https://github.com/RACHAMADUGUSIVASANKAR/Book-portfolio) | `HTML` `CSS` `Javascript` `GitHub Pages` |
| Facial Expression Detection | - | [view](https://github.com/RACHAMADUGUSIVASANKAR/ScriptEmotion-prediction) | `Python` `Github` `Git` `vscode` | 
| Script Emotion prediction | - | [view](https://github.com/RACHAMADUGUSIVASANKAR/ScriptEmotion-prediction) |  `HTML` `CSS`  `python` `kaggle` `flask` `procifile` | 
